...
5. Press **Add more details** or **Open a Case**.
6. For **Description**, enter “Can’t access Cloudflare Help Center My Activities. Following the process mentioned here: https://developers.cloudflare.com/support/account-management-billing/cannot-locate-dashboard-account/.”.
7. Press **Submit Case**.
